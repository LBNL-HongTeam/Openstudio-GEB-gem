...
RSpec.describe OpenStudio::Geb do
  ...
  it "can apply and run single measure" do
    ...
    baseline_dir_str = File.join(File.dirname(__FILE__ ), "../seed_models/Retail_7.osm")   # commercial
  ...
  it "can apply and run multiple measures" do
    # provide baseline path
    baseline_dir_str = File.join(File.dirname(__FILE__ ), "../seed_models/bldg0249347_smlOfc_CA.osm")
    all_measures = list_all_geb_measures
